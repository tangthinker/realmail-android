...
class MailListAdapter(activity: Activity, private val resId: Int, data: List<RealMailService.MailWhitPersonalInfo>):
    ArrayAdapter<RealMailService.MailWhitPersonalInfo>(activity, resId, data) {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        mailWhitPersonalInfo?.let {
            viewHolder.mail_time.text = mailWhitPersonalInfo.realMail.receiveTime
            viewHolder.mail_payload.text = mailWhitPersonalInfo.realMail.mailPayload
